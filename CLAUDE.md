...
- Still to do on the PCB: widen VM/phase traces, resize C3/C5 to the Ø10 mm `CP_Elec_10x10` can, add the C5 footprint (or *Update PCB from Schematic*), swap P1 to a 3-pos terminal block, and the re-layout. The board outline bbox is 26.34×21.27 mm at x[133.7,160.1] y[91.9,113.1]; copper layer count is 4 (F=0, In1=4, In2=6, B=2).
